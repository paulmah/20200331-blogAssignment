...
const sassArticle = new Article( 'Lorem Ipsum (SASS)',
'Phasellus diam tellus, ultrices quis ipsum a, euismod bibendum quam.');


// was not able to isolate the titles of each article to compare CSS string to it. should figure out how to get i as the index of where to insert SASS

// console.log( "number of elements in blogArticles is: " + blogArticles.length )

// let i = 0;
// for ( let article of blogArticles )
// {
//   console.log( Object.values(blogArticles) );
// }

// for (var i = 0; i < blogArticles.length; i++) {
//   console.log ( blogArticles.title );
// }

blogArticles.splice( 3, 0, sassArticle );
